package com.example.spring_Webclient_to_consume_restful_crud_api.controller;

import com.example.spring_Webclient_to_consume_restful_crud_api.entity.BookRequest;
...
public class BookController {
   ...
   public Mono<String> BookNow(@RequestBody BookRequest request){
    ...
    public Mono<BookRequest> getBookingId(@PathVariable int bookingId){
